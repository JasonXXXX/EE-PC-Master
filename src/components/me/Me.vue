<template>
  <div class="config-wrap">
    ...
    <el-menu :default-active="meState" class="el-menu-vertical-demo config-wrap-tab" :collapse="collapse" router>
      ...
      <el-menu-item class="wrap-nav" index="/me/note"><icon class="wrap-nav-icon" name="book"></icon><span slot="title">笔记</span></el-menu-item>

      <el-menu-item class="wrap-nav" index="/me/plan"><icon class="wrap-nav-icon" name="calendar-check-o"></icon><span slot="title">学习计划</span></el-menu-item>
