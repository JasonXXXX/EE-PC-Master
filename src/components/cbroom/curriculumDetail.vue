<template>
    <div>
      <div class="title">
        <router-link class="router-link" to="/cbroom/curriculum"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></router-link>
...
export default {
  ...
  methods: {
    ...
    fetchmicrolectureDetail() {
      ...
      params.append('course_id', this.$route.params.courseid)

      this.$common.http.get(this.$common.api.MicrocourseInfo, params)
        .then(response => {
